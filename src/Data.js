...
export const pizzaTerminal = {
  name: "Terminal Pizza",
  description: "Terminal kullanımına alışkın olanların damak zevkine hitap eden bir pizza!",
  price: "60₺",
  rate: 4.9,
  comments: 200,
  toppings: [
...
export const burger = {
  ...
  description: "React geliştiricileri için lezzetli bir tavuklu burger!",
  price: "60₺",
  rate: 4.9,
  comments: 200,
};
...
export const doughOptions = [
  { id: "thick", label: "Kalın Hamur" },
  { id: "thin", label: "İnce Hamur" },
  { id: "classic", label: "Klasik Hamur" },
];

export const icons = [
  { id: 1, src: "images/iteration-2-images/icons/1.svg" },
  { id: 2, src: "images/iteration-2-images/icons/2.svg" },
  { id: 3, src: "images/iteration-2-images/icons/3.svg" },
  { id: 4, src: "images/iteration-2-images/icons/4.svg" },
  { id: 5, src: "images/iteration-2-images/icons/5.svg" },
  { id: 6, src: "images/iteration-2-images/icons/6.svg" },
];
